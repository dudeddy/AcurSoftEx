...
Namespace AcurSoft.XtraEditors
    ...
    Public Class YearEdit
        Inherits DateEdit

        'The static constructor which calls the registration method
        Shared Sub New()
            RepositoryItemYearEdit.RegisterEdit()
        End Sub

        'Initialize the new instance
        Public Sub New()
            '...
            'MyBase.EditValue = Date.Today.Year
        End Sub

        'Return the unique name
        Public Overrides ReadOnly Property EditorTypeName() As String
            Get
                Return RepositoryItemYearEdit.CustomEditName
            End Get
        End Property
        ...
        Public Shadows ReadOnly Property Properties() As RepositoryItemYearEdit
            Get
                Return TryCast(MyBase.Properties, RepositoryItemYearEdit)
            End Get
        End Property
